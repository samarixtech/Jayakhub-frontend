...
const TopBar = ({ isScrolled }: TopBarProps) => {
  ...
  return (
    <div
      className={`flex items-center justify-start md:justify-center bg-primary t px-4 md:px-6 overflow-x-auto scrollbar-hide transition-all duration-300 h-12 md:h-10 ${
