    ...
    >
      ...
      <div className="relative w-full h-[130px] bg-gray-100 flex items-center justify-center overflow-hidden shrink-0">
        {isValidImageSrc(currentCampaign.image) ? (
          ...
          <div className="flex flex-col items-center gap-2 text-gray-400">
            <Tag className="w-12 h-12 text-gold-deep opacity-60" />
        ...
        {/* Promotion tag badge */}
        <div className="absolute top-4 left-4 flex items-center gap-1.5 bg-secondary text-navy px-3 py-1 rounded-full text-xs font-semibold shadow-md tracking-wide">
      ...
      <div className="p-4 flex flex-col gap-3">
        ...
        {currentCampaign.coupon && (
          <div className="relative border-2 border-dashed border-gold/50 bg-accent rounded-2xl p-3 flex flex-col gap-2 shadow-sm overflow-hidden select-none">
            ...
            <div className="flex items-start justify-between gap-3 px-2">
              <div>
                <span className="text-xs font-bold text-gold-deep uppercase tracking-wider bg-secondary/15 px-2.5 py-1 rounded-md">
            ...
            <div className="flex items-center gap-2 mt-1 bg-white p-2 rounded-xl border border-gold/30">
              ...
              <button
                onClick={handleCopy}
                className="flex items-center gap-1 bg-primary hover:bg-[#e85a2a] text-white px-3.5 py-1.5 rounded-lg text-xs font-semibold active:scale-[0.98] transition-all"
              >
                {copied ? (
                  <>
        ...
        <div className="flex flex-col gap-1.5 mt-1">
          <button
            ...
            className="w-full bg-primary hover:bg-[#e85a2a] active:scale-[0.99] text-white font-semibold py-2.5 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center gap-2"
          >
