...
export default function Hero() {
  ...
  const STATS = [
    ...
    {
      value: t("stats.restaurants.value"),
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-2 pb-4 lg:pt-4 lg:pb-8 z-10">
        <div className="grid lg:grid-cols-2 gap-y-10 gap-x-8 lg:gap-36 items-center">
          {/* Left Content */}
          <div className="space-y-4 lg:space-y-6 text-center lg:text-start">
            ...
            <div
              className={cn(
                "flex flex-wrap justify-center lg:justify-start gap-x-6 gap-y-4 pt-2",
          ...
          <div
            className={cn(
              "relative h-[320px] sm:h-[400px] lg:h-[460px] w-full flex justify-center items-center mt-8 lg:mt-0 transition-all duration-1000 delay-300",
          ...
          >
            ...
            <FloatingCard
              img={falafelImg}
              title="Falafel"
              price={`${currencySymbol}5.99`}
              className="scale-75 sm:scale-90 top-0 end-0 sm:top-8 sm:end-8"
            />
            <FloatingCard
              img={dolmaImg}
              title="Dolma"
              price={`${currencySymbol}8.99`}
              className="scale-75 sm:scale-90 bottom-0 start-0 sm:bottom-16 sm:start-8"
              delay="1s"
              reverse
            />
            <FloatingCard
              img={tabboulehImg}
              title="Tabbouleh"
              price={`${currencySymbol}4.99`}
              className="scale-75 sm:scale-90 top-1/4 -start-4 sm:top-1/3 sm:-start-4"
              delay="1.5s"
            />

            {/* Review Badge - Responsive positioning and scaling */}
            <div className="absolute bottom-0 end-0 sm:bottom-8 sm:end-8 scale-75 sm:scale-90 bg-white rounded-2xl px-3.5 py-2.5 shadow-xl flex items-center gap-2.5">
...
function FloatingCard({
  ...
  return (
    <div
      className={cn(
        "absolute bg-white rounded-2xl p-2 shadow-xl z-20",
