...
export default function Partner() {
  ...
  return (
    <section
      ref={sectionRef}
      className="py-12 bg-[#F8FAFC] relative overflow-hidden min-h-screen flex flex-col justify-center"
    >
        ...
        <div className="bg-primary rounded-[2.5rem] p-8 md:p-10 relative overflow-hidden shadow-2xl shadow-primary/20">
          ...
          >
            ...
            <h2 className="text-4xl sm:text-5xl font-bold text-white mb-4">
              {t("title_prefix")}{" "}
              <span className="text-accent-yellow">{t("title_highlight")}</span>
            </h2>
            ...
            {partnerOptions.map((option, index) => (
              ...
              >
                ...
                <div className="absolute inset-0">
                  ...
                  />
                  <div
                    className={`absolute inset-0 bg-linear-to-br ${option.gradient} opacity-90`}
                  />
                </div>
