...
export default function MarketingView() {
    return (
        <div className="w-full max-w-6xl mx-auto p-6 flex flex-col gap-6">
            {/* Hero Banner */}
            <div className="w-full rounded-2xl bg-gradient-to-r from-[#1E9E74] to-[#38C894] p-10 flex flex-col items-center justify-center text-center text-white relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-2xl">
                    ...
                    <p className="text-sm md:text-base text-white/90 leading-relaxed font-light">
                        Choose a transparent marketing package and let JayakHub drive local<br className="hidden md:block" />
            ...
            <div className="w-full py-2 mb-2 mt-4">
                <h2 className="text-[16px] font-bold text-gray-900 tracking-tight">Available Packages</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 w-full">
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-5 md:p-6 flex flex-col h-full relative">
                    <div className="mb-4">
                        <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-1.5">Storefront Visibility</h3>
                        <p className="text-[12px] md:text-[13px] text-gray-500 leading-relaxed min-h-[36px]">
                            Get discovered by more local diners. The essential tools to rank higher and look great on JayakHub.
                        </p>
                    </div>

                    <div className="mb-6">
                        <div className="flex items-baseline text-gray-900">
                            <span className="text-3xl md:text-4xl font-black tracking-tight">$49</span>
                            <span className="text-xs md:text-sm font-semibold text-gray-400 ml-1">/ mo</span>
                        </div>
                    </div>
                        ...
                        <ul className="space-y-3 mb-6">
                            {[
                                ...
                                <li key={idx} className="flex items-start gap-2.5">
                                    <CheckCircle2 className="w-4 h-4 mt-0.5 text-[#346853] shrink-0 fill-white" strokeWidth={1.5} />
                                    <span className="text-[12px] md:text-[13px] text-gray-700 font-medium">{feature}</span>
                                </li>
                            ))}
                        </ul>
                    </div>
                ...
                <div className="bg-white rounded-xl border-2 border-[#346853] p-5 md:p-6 flex flex-col h-full relative overflow-hidden shadow-lg shadow-[#346853]/5">
                    ...
                    <div className="mb-4">
                        <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-1.5">Growth Partner</h3>
                        <p className="text-[12px] md:text-[13px] text-gray-500 leading-relaxed min-h-[36px] pr-8">
                            A complete marketing engine. We actively promote your restaurant to drive high-volume orders.
                        </p>
                    </div>

                    <div className="mb-6">
                        <div className="flex items-baseline text-gray-900">
                            <span className="text-3xl md:text-4xl font-black tracking-tight">$129</span>
                            <span className="text-xs md:text-sm font-semibold text-gray-400 ml-1">/ mo</span>
                        </div>
                    </div>
