...
const TransactionDetailSidebar = ({
  open,
  onOpenChange,
  transaction,
          ...
          <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="bg-white rounded-xl p-4 border border-gray-100 shadow-sm flex flex-col justify-center items-start">
                ...
                <span
                  className={`px-3 py-1 rounded-full text-[12px] font-bold ${transaction.type === "Refund" ? "bg-red-50 text-red-600" : "bg-gray-100 text-gray-600"}`}
                >
                  {transaction.type}
                </span>
              </div>
