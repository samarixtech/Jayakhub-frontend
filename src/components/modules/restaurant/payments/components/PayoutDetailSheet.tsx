            ...
            >
                <div className="flex flex-col h-full">
                    ...
                    <div className="px-7 py-5 space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div className="border border-gray-200 rounded-xl px-4 py-3">
                                <span className="text-[10px] font-semibold text-navy uppercase tracking-wider block mb-1">{t("period")}</span>
                                <span className="text-[14px] font-bold text-[#1a1a1a]">{t("periodValue")}</span>
                            </div>
                            <div className="border border-gray-200 rounded-xl px-4 py-3">
                                <span className="text-[10px] font-semibold text-navy uppercase tracking-wider block mb-1">{t("ordersIncluded")}</span>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div className="border border-gray-200 rounded-xl px-4 py-3">
                                <span className="text-[10px] font-semibold text-navy uppercase tracking-wider block mb-1">Requested</span>
                                <span className="text-[14px] font-bold text-[#1a1a1a]">{createdDate}</span>
                            </div>
                            <div className="border border-gray-200 rounded-xl px-4 py-3">
                                <span className="text-[10px] font-semibold text-navy uppercase tracking-wider block mb-1">Processed</span>
