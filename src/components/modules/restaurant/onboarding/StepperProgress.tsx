    ...
    <div className="w-full overflow-x-auto pb-4 scrollbar-hide">
      <div className="relative flex justify-between min-w-[800px] w-full my-7 px-10">
        ...
        {STEPS.map((step) => (
          ...
          >
            <div
              className={`h-8 w-8 rounded-full flex items-center justify-center text-xs font-bold transition-all duration-300 ${currentStep >= step.id
            ...
            <span
              className={`text-[10px] font-bold uppercase tracking-wider transition-colors duration-300 ${currentStep >= step.id ? "text-[#346853]" : "text-gray-300"
                }`}
            >
              {step.label}
            </span>
