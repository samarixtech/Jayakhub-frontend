...
export const SupportSearchBanner = () => {
  ...
  return (
    <div className="w-full rounded-2xl bg-gradient-to-r from-[#FF6B35] to-[#E85A2A] px-8 py-12 mb-6 text-center text-white relative flex flex-col items-center justify-center shadow-sm overflow-hidden">
      <div className="absolute top-0 right-0 w-[400px] h-full bg-white/5 transform -skew-x-[35deg] origin-top translate-x-32" />
      <div className="absolute top-0 right-0 w-[250px] h-[250px] bg-[#E85A2A] rounded-full blur-3xl translate-x-1/3 -translate-y-1/3 opacity-80" />
