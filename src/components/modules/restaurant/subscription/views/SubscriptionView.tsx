...
function formatAmountInCurrency(
...
export default function SubscriptionView() {
  ...
  const { isExpired: isPlanExpired, isCancelled: isPlanCancelled } =
    usePlanAccess();
          ...
          <div className="sm:px-6 flex flex-col gap-1.5">
            ...
            <ul className="grid grid-cols-2 gap-x-4 gap-y-2 mt-1">
              {featureLabels.length > 0 ? (
                ...
                <li className="text-xs text-gray-400 col-span-2">
                  No features listed
                </li>
              )}
            </ul>
              ...
              <div className="flex items-center justify-between px-6 py-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400">
                      {autoRenew
                        ? `Next billing: ${renewalDateFormatted}`
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to cancel your subscription? Your dashboard
              access will be restricted to the Subscription page only until you
              resubscribe. This action cannot be undone.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-100 bg-gray-50/60">
                {["Subscription ID", "Date", "Amount", "Plan", "Status"].map(
                  (h) => (
                    <th
                      key={h}
                  ...
                  >
                    ...
                    <td className="px-6 py-3.5 font-semibold text-gray-900 font-mono">
                      {row.convertedPrice != null
                        ? formatAmountInCurrency(
                            row.convertedPrice,
                            row.convertedCurrency ?? undefined,
                          )
