...
import { OnboardingProvider, useOnboarding } from "@/components/modules/restaurant/onboarding/OnboardingContext";
...
const OnboardingLayoutContent = ({ children }: { children: React.ReactNode }) => {
  ...
  else if (pathname.includes("step-kyc")) currentStep = 4;
